...
<script type="text/babel">
  ...
  import scrollIntoView from 'main/webapp/element-ui/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'main/webapp/element-ui/src/utils/util';
  import NavigationMixin from './navigation-mixin';
  import { isKorean } from 'main/webapp/element-ui/src/utils/shared';
